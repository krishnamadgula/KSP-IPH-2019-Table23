...
INSERT into tasks (id,title,description,`status`,assignee,created_by) VALUES (1, 'Forensic Reports', 'The Forensic Report must be collected and documented.','DOING','Vijay','Kumar');
